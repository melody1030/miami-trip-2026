  ...
  await setDoc(doc(db, 'days', 'day-1'), {
    ...
    items: [
      ...
      },
      {
        ...
        address: '1245 Lincoln Rd, Miami Beach, FL 33139',
        sortOrder: 4,
      },
    ],
  })
    ...
    items: [
      {
        ...
        address: '1414 Collins Ave, Miami Beach, FL 33139',
        sortOrder: 1,
      },
      {
        id: 'd2-2',
        type: 'restaurant',
        title: 'Sanguich de Miami',
        time: '11:30 AM',
